...
/**
 * 本demo是一个在线修改抓取规则的例子，DyncmicQuebrada支持规则类的重新加载，不需要重启应用
 * 
 * @author huchengyi
 *
 */
public class DynamicRuleTest {
	...
	public static void main(String[] args) throws Exception {
		...
		QuebradaEngine ge = QuebradaEngine.create("com.quebrada.demo.dynamic")
		.interval(5000)
		.loop(true)
		.engineStart();
		
		//定义爬取规则
		Class<?> rule = DynamicQuebrada
		.html()
		.quebrada("https://github.com/xtuhcy/gecco", "consolePipeline")
