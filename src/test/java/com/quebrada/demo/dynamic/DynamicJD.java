...
public class DynamicJD {
	...
	public static void main(String[] args) {
		...
		Class<?> category = DynamicQuebrada.html()
		...
		//对应原来的AllSort类
		DynamicQuebrada.html()
		.quebrada("http://www.jd.com/allSort.aspx", "consolePipeline", "allSortJsonPipeline")
		...
		//对应ProductBrief类
		Class<?> productBrief = DynamicQuebrada.html()
		...
		//对应ProductList类
		DynamicQuebrada.html()
		.quebrada("http://list.jd.com/list.html?cat={cat}&delivery={delivery}&page={page}&JL={JL}&go=0", "consolePipeline", "productListJsonPipeline")
		.requestField("request").request().build()
		...
		//对应ProductDetail类
		DynamicQuebrada.html()
		.quebrada("http://item.jd.com/{code}.html", "consolePipeline")
		...
		.classpath("com.quebrada.demo.dynamic")
		.start(start)
		.interval(2000)
		.run();
