...
public abstract class DownloaderFactory {
	...
	public DownloaderFactory(Reflections reflections) {
		...
		Set<Class<?>> classes = reflections.getTypesAnnotatedWith(com.quebrada.annotation.Downloader.class);
		for(Class<?> downloaderClass : classes) {
			com.quebrada.annotation.Downloader downloader = (com.quebrada.annotation.Downloader)downloaderClass.getAnnotation(com.quebrada.annotation.Downloader.class);
			try {
