...
import com.quebrada.downloader.Downloader;
...
import com.quebrada.downloader.AfterDownload;
import com.quebrada.response.HttpResponse;
import com.quebrada.scheduler.UniqueSpiderScheduler;
...
public class Spider implements Runnable {
	...
	public Spider(QuebradaEngine engine) {
		this.engine = engine;
	...
	public QuebradaEngine getEngine() {
		return engine;
	}
